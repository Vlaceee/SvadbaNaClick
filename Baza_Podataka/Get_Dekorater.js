...
//     const query = 'SELECT * FROM Dekorater WHERE ID = ?';

//     connection.query(query, [dekoraterId], (err, results) => {
...
function getDekoraterInfo(dekoraterId, callback) {
