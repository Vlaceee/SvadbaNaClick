  ...
  return (
    <div className="flex w-full flex-col items-center">
      <div className="mb-20 mt-8 flex flex-col items-center ">
        ...
        <button>
          {' '}
          <Link className="mx-2 my-6 flex w-56 items-center justify-center rounded-lg bg-sncpink p-2 text-white shadow-lg hover:text-snclbrown" to="/admin/ads">
            {t('Go to Admin Ads')}

          </Link>
          <button>
            {' '}
            <Link className="mx-2 mb-6 flex w-56 items-center justify-center rounded-lg bg-snclblue p-2 text-white shadow-lg hover:text-snclbrown" to="/admin/clients">
              {t('Go to Clients')}
