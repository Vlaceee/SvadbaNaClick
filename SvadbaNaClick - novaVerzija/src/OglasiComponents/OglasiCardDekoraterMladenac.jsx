...
export default function OglasiCardDekoraterMladenci({ dekorater, korisnik }) {
  ...
  return (
    ...
    >
        ...
        subheader={(
          <>
            <Typography variant="body2" color="text.secondary">
              {t('Datum Osnivanja')}
              {' '}
              {dekorater._DatumOsnivanja.toDateString()}
            </Typography>
            <Rating name="read-only" value={dekorater.Ocena} precision={0.1} readOnly />
          </>
        )}
      />
      <Typography
      ...
      <CardActions disableSpacing>
        ...
        <LikeButton korisnik={korisnik} oglas={dekorater} />
